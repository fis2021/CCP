...
import static sample.DataBase.GraphicCardsService.Increment;
...
public class GraphicCards {
    ...
    public static void Test1(String nume1,String descriere1,String pret1,String tip1,String garantie1,String id)
    {
        for(int i=0;i<10;i++)
        {
        ...
        for(int i=0;i< buttons1.size();i++)
        {
            ...
            buttons1.get(i).setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    {
                        GraphicCardsService.Increment(nume.get(nr).getText(),pret.get(nr).getText(),tip.get(nr).getText(),garantie.get(nr).getText(),descriere.get(nr).getText());
                        return;
